                                    ...
                                    <div className="p-5">
                                        ...
                                        <form className="user" onSubmit={handleSubmit}>
                                            ...
                                            {errors.confirmNewPassword && touched.confirmNewPassword ? (
                                                <p className='form-error text-danger'>{errors.confirmNewPassword}</p>
                                            ) : null}

                                            <input type='submit' className="btn btn-primary btn-user btn-block" value="Reset your password" />
